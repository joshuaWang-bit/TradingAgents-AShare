...
DEFAULT_CONFIG = {
    ...
    "openai_reasoning_effort": os.getenv("TA_OPENAI_REASONING_EFFORT") or None,    # "minimal", "low", "medium", "high", "xhigh"
    "openai_use_responses_api": os.getenv("TA_OPENAI_USE_RESPONSES_API", "").lower() in ("1", "true", "yes", "on"),
    "openai_disable_response_storage": os.getenv("TA_OPENAI_DISABLE_RESPONSE_STORAGE", "").lower() in ("1", "true", "yes", "on"),
